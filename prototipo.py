...
#Printa os runs do documento. Assim eu consigo visualizar os pontos em que há quebra de run nas palavras chave (parte da palavra chave fica em uma run e outra parte se separa e fica em outra run, impedindo o programa de substituir corretamente)
